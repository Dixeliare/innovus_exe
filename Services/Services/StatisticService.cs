...
public class StatisticService : IStatisticService
{
    private readonly StatisticRepository _statisticRepository;
        ...
        public async Task<StatisticDto> AddAsync(CreateStatisticDto createStatisticDto)
        {
            ...
            var addedStatistic = await _statisticRepository.AddAsync(statisticEntity);
        ...
        {
            var existingStatistic = await _statisticRepository.GetByIdAsync(updateStatisticDto.StatisticId);
            ...
            await _statisticRepository.UpdateAsync(existingStatistic);
        }
